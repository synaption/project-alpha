...
def _load_truetype_tileset(active_tileset: str, text_scale_setting: object):
...
def _load_hexany_tileset_from_zip():
    ...
    extracted = Path(gettempdir()) / "pyrl-tilesets" / Path(_HEXANY_TILESET_ZIP).stem / "general_transparent.png"
